...
class Router {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.0+sha-fe653c2", ngImport: i0, type: Router, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.0.0+sha-fe653c2", ngImport: i0, type: Router, providedIn: 'root' }); }
}
export { Router };
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.0.0+sha-fe653c2", ngImport: i0, type: Router, decorators: [{
            type: Injectable,
