...
class RouterConfigLoader {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.0-rc.2+sha-022ed5a", ngImport: i0, type: RouterConfigLoader, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.0.0-rc.2+sha-022ed5a", ngImport: i0, type: RouterConfigLoader, providedIn: 'root' }); }
}
export { RouterConfigLoader };
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.0.0-rc.2+sha-022ed5a", ngImport: i0, type: RouterConfigLoader, decorators: [{
            type: Injectable,
