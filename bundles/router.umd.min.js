...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function kt(t){return"function"==typeof t}function It(t){return t instanceof D}var Lt,Mt=Symbol("INITIAL_VALUE");function Nt(){return i.switchMap((function(t){return n.combineLatest.apply(void 0,c(t.map((function(t){return t.pipe(i.take(1),i.startWith(Mt))})))).pipe(i.scan((function(t,e){var r=!1;return e.reduce((function(t,n,i){if(t!==Mt)return t;if(n===Mt&&(r=!0),!r){if(!1===n)return n;if(i===e.length-1||It(n))return n}return t}),t)}),Mt),i.filter((function(t){return t!==Mt})),i.map((function(t){return It(t)?t:!0===t})),i.take(1))}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Jt=function Jt(t){this.path=t,this.route=this.path[this.path.length-1]},Xt=function Xt(t,e){this.component=t,this.route=e};function te(t,e,r){var n=function i(t){if(!t)return null;for(var e=t.parent;e;e=e.parent){var r=e.routeConfig;if(r&&r._loadedConfig)return r._loadedConfig}return null}(e);return(n?n.module.injector:r).get(t)}function ee(t,e,r,n,i){void 0===i&&(i={canDeactivateChecks:[],canActivateChecks:[]});var o=st(e);return t.children.forEach((function(t){!function e(t,r,n,i,o){void 0===o&&(o={canDeactivateChecks:[],canActivateChecks:[]});var a=t.value,u=r?r.value:null,s=n?n.getContext(t.value.outlet):null;if(u&&a.routeConfig===u.routeConfig){var c=function l(t,e,r){if("function"==typeof r)return r(t,e);switch(r){case"pathParamsChange":return!H(t.url,e.url);case"pathParamsOrQueryParamsChange":return!H(t.url,e.url)||!T(t.queryParams,e.queryParams);case"always":return!0;case"paramsOrQueryParamsChange":return!yt(t,e)||!T(t.queryParams,e.queryParams);case"paramsChange":default:return!yt(t,e)}}(u,a,a.routeConfig.runGuardsAndResolvers);c?o.canActivateChecks.push(new Jt(i)):(a.data=u.data,a._resolvedData=u._resolvedData),ee(t,r,a.component?s?s.children:null:n,i,o),c&&o.canDeactivateChecks.push(new Xt(s&&s.outlet&&s.outlet.component||null,u))}else u&&re(r,s,o),o.canActivateChecks.push(new Jt(i)),ee(t,null,a.component?s?s.children:null:n,i,o)}(t,o[t.value.outlet],r,n.concat([t.value]),i),delete o[t.value.outlet]})),L(o,(function(t,e){return re(t,r.getContext(e),i)})),i}function re(t,e,r){var n=st(t),i=t.value;L(n,(function(t,n){re(t,i.component?e?e.children.getContext(n):null:e,r)})),r.canDeactivateChecks.push(new Xt(i.component&&e&&e.outlet&&e.outlet.isActivated?e.outlet.component:null,i))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var ir=new r.Version("11.0.0-next.0+43.sha-4360eed");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
