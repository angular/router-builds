...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function T(t,e){var r,n=Object.keys(t),i=Object.keys(e);if(!n||!i||n.length!=i.length)return!1;for(var o=0;o<n.length;o++)if(!E(t[r=n[o]],e[r]))return!1;return!0}function E(t,e){return Array.isArray(t)&&Array.isArray(e)?t.length==e.length&&t.every((function(t){return e.indexOf(t)>-1})):t===e}function k(t){return Array.prototype.concat.apply([],t)}function I(t){return t.length>0?t[t.length-1]:null}function L(t,e){for(var r in t)t.hasOwnProperty(r)&&e(t[r],r)}function M(t){return r.ɵisObservable(t)?t:r.ɵisPromise(t)?n.from(Promise.resolve(t)):n.of(t)}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Bt=function Bt(t){this.path=t,this.route=this.path[this.path.length-1]},Qt=function Qt(t,e){this.component=t,this.route=e};function Vt(t,e,r){var n=function i(t){if(!t)return null;for(var e=t.parent;e;e=e.parent){var r=e.routeConfig;if(r&&r._loadedConfig)return r._loadedConfig}return null}(e);return(n?n.module.injector:r).get(t)}function Zt(t,e,r,n,i){void 0===i&&(i={canDeactivateChecks:[],canActivateChecks:[]});var o=st(e);return t.children.forEach((function(t){!function e(t,r,n,i,o){void 0===o&&(o={canDeactivateChecks:[],canActivateChecks:[]});var a=t.value,u=r?r.value:null,s=n?n.getContext(t.value.outlet):null;if(u&&a.routeConfig===u.routeConfig){var c=function l(t,e,r){if("function"==typeof r)return r(t,e);switch(r){case"pathParamsChange":return!H(t.url,e.url);case"pathParamsOrQueryParamsChange":return!H(t.url,e.url)||!T(t.queryParams,e.queryParams);case"always":return!0;case"paramsOrQueryParamsChange":return!yt(t,e)||!T(t.queryParams,e.queryParams);case"paramsChange":default:return!yt(t,e)}}(u,a,a.routeConfig.runGuardsAndResolvers);c?o.canActivateChecks.push(new Bt(i)):(a.data=u.data,a._resolvedData=u._resolvedData),Zt(t,r,a.component?s?s.children:null:n,i,o),c&&o.canDeactivateChecks.push(new Qt(s&&s.outlet&&s.outlet.component||null,u))}else u&&Yt(r,s,o),o.canActivateChecks.push(new Bt(i)),Zt(t,null,a.component?s?s.children:null:n,i,o)}(t,o[t.value.outlet],r,n.concat([t.value]),i),delete o[t.value.outlet]})),L(o,(function(t,e){return Yt(t,r.getContext(e),i)})),i}function Yt(t,e,r){var n=st(t),i=t.value;L(n,(function(t,n){Yt(t,i.component?e?e.children.getContext(n):null:e,r)})),r.canDeactivateChecks.push(new Qt(i.component&&e&&e.outlet&&e.outlet.isActivated?e.outlet.component:null,i))}var $t=Symbol("INITIAL_VALUE");function Kt(){return i.switchMap((function(t){return n.combineLatest.apply(void 0,c(t.map((function(t){return t.pipe(i.take(1),i.startWith($t))})))).pipe(i.scan((function(t,e){var r=!1;return e.reduce((function(t,n,i){if(t!==$t)return t;if(n===$t&&(r=!0),!r){if(!1===n)return n;if(i===e.length-1||It(n))return n}return t}),t)}),$t),i.filter((function(t){return t!==$t})),i.map((function(t){return It(t)?t:!0===t})),i.take(1))}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var nr=new r.Version("10.0.14+27.sha-f815aa1");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
