...
/**
     ...
     */var g,v=function(t){function e(e,r,n,o){void 0===n&&(n="imperative"),void 0===o&&(o=null);var i=t.call(this,e,r)||this;return i.navigationTrigger=n,i.restoredState=o,i}return u(e,t),e.prototype.toString=function(){return"NavigationStart(id: "+this.id+", url: '"+this.url+"')"},e}(g=function g(t,e){this.id=t,this.url=e}),m=function(t){function e(e,r,n){var o=t.call(this,e,r)||this;return o.urlAfterRedirects=n,o}return u(e,t),e.prototype.toString=function(){return"NavigationEnd(id: "+this.id+", url: '"+this.url+"', urlAfterRedirects: '"+this.urlAfterRedirects+"')"},e}(g),y=function(t){function e(e,r,n){var o=t.call(this,e,r)||this;return o.reason=n,o}return u(e,t),e.prototype.toString=function(){return"NavigationCancel(id: "+this.id+", url: '"+this.url+"')"},e}(g),S=function(t){function e(e,r,n){var o=t.call(this,e,r)||this;return o.error=n,o}return u(e,t),e.prototype.toString=function(){return"NavigationError(id: "+this.id+", url: '"+this.url+"', error: "+this.error+")"},e}(g),w=function(t){function e(e,r,n,o){var i=t.call(this,e,r)||this;return i.urlAfterRedirects=n,i.state=o,i}return u(e,t),e.prototype.toString=function(){return"RoutesRecognized(id: "+this.id+", url: '"+this.url+"', urlAfterRedirects: '"+this.urlAfterRedirects+"', state: "+this.state+")"},e}(g),b=function(t){function e(e,r,n,o){var i=t.call(this,e,r)||this;return i.urlAfterRedirects=n,i.state=o,i}return u(e,t),e.prototype.toString=function(){return"GuardsCheckStart(id: "+this.id+", url: '"+this.url+"', urlAfterRedirects: '"+this.urlAfterRedirects+"', state: "+this.state+")"},e}(g),C=function(t){function e(e,r,n,o,i){var a=t.call(this,e,r)||this;return a.urlAfterRedirects=n,a.state=o,a.shouldActivate=i,a}return u(e,t),e.prototype.toString=function(){return"GuardsCheckEnd(id: "+this.id+", url: '"+this.url+"', urlAfterRedirects: '"+this.urlAfterRedirects+"', state: "+this.state+", shouldActivate: "+this.shouldActivate+")"},e}(g),R=function(t){function e(e,r,n,o){var i=t.call(this,e,r)||this;return i.urlAfterRedirects=n,i.state=o,i}return u(e,t),e.prototype.toString=function(){return"ResolveStart(id: "+this.id+", url: '"+this.url+"', urlAfterRedirects: '"+this.urlAfterRedirects+"', state: "+this.state+")"},e}(g),P=function(t){function e(e,r,n,o){var i=t.call(this,e,r)||this;return i.urlAfterRedirects=n,i.state=o,i}return u(e,t),e.prototype.toString=function(){return"ResolveEnd(id: "+this.id+", url: '"+this.url+"', urlAfterRedirects: '"+this.urlAfterRedirects+"', state: "+this.state+")"},e}(g),U=function(){function t(t){this.route=t}return t.prototype.toString=function(){return"RouteConfigLoadStart(path: "+this.route.path+")"},t}(),O=function(){function t(t){this.route=t}return t.prototype.toString=function(){return"RouteConfigLoadEnd(path: "+this.route.path+")"},t}(),x=function(){function t(t){this.snapshot=t}return t.prototype.toString=function(){return"ChildActivationStart(path: '"+(this.snapshot.routeConfig&&this.snapshot.routeConfig.path||"")+"')"},t}(),A=function(){function t(t){this.snapshot=t}return t.prototype.toString=function(){return"ChildActivationEnd(path: '"+(this.snapshot.routeConfig&&this.snapshot.routeConfig.path||"")+"')"},t}(),T=function(){function t(t){this.snapshot=t}return t.prototype.toString=function(){return"ActivationStart(path: '"+(this.snapshot.routeConfig&&this.snapshot.routeConfig.path||"")+"')"},t}(),E=function(){function t(t){this.snapshot=t}return t.prototype.toString=function(){return"ActivationEnd(path: '"+(this.snapshot.routeConfig&&this.snapshot.routeConfig.path||"")+"')"},t}(),j=function(){function t(t,e,r){this.routerEvent=t,this.position=e,this.anchor=r}return t.prototype.toString=function(){return"Scroll(anchor: '"+this.anchor+"', position: '"+(this.position?this.position[0]+", "+this.position[1]:null)+"')"},t}(),I=function(){return c([e.Component({template:"<router-outlet></router-outlet>"})],function t(){})}(),_="primary",k=function(){function t(t){this.params=t||{}}return t.prototype.has=function(t){return this.params.hasOwnProperty(t)},t.prototype.get=function(t){if(this.has(t)){var e=this.params[t];return Array.isArray(e)?e[0]:e}return null},t.prototype.getAll=function(t){if(this.has(t)){var e=this.params[t];return Array.isArray(e)?e:[e]}return[]},Object.defineProperty(t.prototype,"keys",{get:function(){return Object.keys(this.params)},enumerable:!0,configurable:!0}),t}();function L(t){return new k(t)}function M(t,e,r){var n=r.path.split("/");if(n.length>t.length)return null;if("full"===r.pathMatch&&(e.hasChildren()||n.length<t.length))return null;for(var o={},i=0;i<n.length;i++){var a=n[i],u=t[i];if(a.startsWith(":"))o[a.substring(1)]=u;else if(a!==u.path)return null}return{consumed:t.slice(0,n.length),posParams:o}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function he(t,e,r,n){var o=ee(t,e,n);return V(o.resolve?o.resolve(e,r):o(e,r))}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function fe(t){return function(e){return e.pipe(n.switchMap(function(e){var o=t(e);return o?r.from(o).pipe(n.map(function(){return e})):r.from([e])}))}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Be(){return new e.NgProbeToken("Router",Re)}var Ge=function(){function t(t,e){}var r;return r=t,t.forRoot=function(t,n){return{ngModule:r,providers:[ze,Ze(t),{provide:De,useFactory:Ve,deps:[[Re,new e.Optional,new e.SkipSelf]]},{provide:qe,useValue:n||{}},{provide:o.LocationStrategy,useFactory:Qe,deps:[o.PlatformLocation,[new e.Inject(o.APP_BASE_HREF),new e.Optional],qe]},{provide:Me,useFactory:We,deps:[Re,o.ViewportScroller,qe]},{provide:Ie,useExisting:n&&n.preloadingStrategy?n.preloadingStrategy:ke},{provide:e.NgProbeToken,multi:!0,useFactory:Be},function i(){return[Ye,{provide:e.APP_INITIALIZER,multi:!0,useFactory:$e,deps:[Ye]},{provide:Je,useFactory:Ke,deps:[Ye]},{provide:e.APP_BOOTSTRAP_LISTENER,multi:!0,useExisting:Je}]}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */()]}},t.forChild=function(t){return{ngModule:r,providers:[Ze(t)]}},r=c([e.NgModule({declarations:Ne,exports:Ne,entryComponents:[I]}),l(0,e.Optional()),l(0,e.Inject(De)),l(1,e.Optional()),p("design:paramtypes",[Object,Re])],t)}();function We(t,e,r){return r.scrollOffset&&e.setOffset(r.scrollOffset),new Me(t,e,r)}function Qe(t,e,r){return void 0===r&&(r={}),r.useHash?new o.HashLocationStrategy(t,e):new o.PathLocationStrategy(t,e)}function Ve(t){if(t)throw new Error("RouterModule.forRoot() called twice. Lazy loaded modules should use RouterModule.forChild() instead.");return"guarded"}function Ze(t){return[{provide:e.ANALYZE_FOR_ENTRY_COMPONENTS,multi:!0,useValue:t},{provide:ve,multi:!0,useValue:t}]}var Ye=function(){function t(t){this.injector=t,this.initNavigation=!1,this.resultOfPreactivationDone=new r.Subject}return t.prototype.appInitializer=function(){var t=this;return this.injector.get(o.LOCATION_INITIALIZED,Promise.resolve(null)).then(function(){var e=null,n=new Promise(function(t){return e=t}),o=t.injector.get(Re),i=t.injector.get(qe);if(t.isLegacyDisabled(i)||t.isLegacyEnabled(i))e(!0);else if("disabled"===i.initialNavigation)o.setUpLocationChangeListener(),e(!0);else{if("enabled"!==i.initialNavigation)throw new Error("Invalid initialNavigation options: '"+i.initialNavigation+"'");o.hooks.afterPreactivation=function(){return t.initNavigation?r.of(null):(t.initNavigation=!0,e(!0),t.resultOfPreactivationDone)},o.initialNavigation()}return n})},t.prototype.bootstrapListener=function(t){var r=this.injector.get(qe),n=this.injector.get(Le),o=this.injector.get(Me),i=this.injector.get(Re),a=this.injector.get(e.ApplicationRef);t===a.components[0]&&(this.isLegacyEnabled(r)?i.initialNavigation():this.isLegacyDisabled(r)&&i.setUpLocationChangeListener(),n.setUpPreloading(),o.init(),i.resetRootComponentType(a.componentTypes[0]),this.resultOfPreactivationDone.next(null),this.resultOfPreactivationDone.complete())},t.prototype.isLegacyEnabled=function(t){return"legacy_enabled"===t.initialNavigation||!0===t.initialNavigation||void 0===t.initialNavigation},t.prototype.isLegacyDisabled=function(t){return"legacy_disabled"===t.initialNavigation||!1===t.initialNavigation},c([e.Injectable(),p("design:paramtypes",[e.Injector])],t)}();function $e(t){return t.appInitializer.bind(t)}function Ke(t){return t.bootstrapListener.bind(t)}var Je=new e.InjectionToken("Router Initializer"),Xe=new e.Version("7.0.0+76.sha-bfeceb3.with-local-changes");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.RouterLink=Pe,t.RouterLinkWithHref=Ue,t.RouterLinkActive=xe,t.RouterOutlet=Ee,t.ActivationEnd=E,t.ActivationStart=T,t.ChildActivationEnd=A,t.ChildActivationStart=x,t.GuardsCheckEnd=C,t.GuardsCheckStart=b,t.NavigationCancel=y,t.NavigationEnd=m,t.NavigationError=S,t.NavigationStart=v,t.ResolveEnd=P,t.ResolveStart=R,t.RouteConfigLoadEnd=O,t.RouteConfigLoadStart=U,t.RouterEvent=g,t.RoutesRecognized=w,t.Scroll=j,t.RouteReuseStrategy=de,t.Router=Re,t.ROUTES=ve,t.ROUTER_CONFIGURATION=qe,t.ROUTER_INITIALIZER=Je,t.RouterModule=Ge,t.provideRoutes=Ze,t.ChildrenOutletContexts=Te,t.OutletContext=Ae,t.NoPreloading=ke,t.PreloadAllModules=_e,t.PreloadingStrategy=Ie,t.RouterPreloader=Le,t.ActivatedRoute=Ct,t.ActivatedRouteSnapshot=Pt,t.RouterState=wt,t.RouterStateSnapshot=Ut,t.PRIMARY_OUTLET=_,t.convertToParamMap=L,t.UrlHandlingStrategy=ye,t.DefaultUrlSerializer=et,t.UrlSegment=K,t.UrlSegmentGroup=$,t.UrlSerializer=tt,t.UrlTree=Y,t.VERSION=Xe,t.ɵEmptyOutletComponent=I,t.ɵROUTER_PROVIDERS=ze,t.ɵflatten=B,Object.defineProperty(t,"__esModule",{value:!0})});