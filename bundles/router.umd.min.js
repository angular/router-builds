...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function we(t){return function(e){return e.pipe(o.switchMap((function(e){var r=t(e);return r?n.from(r).pipe(o.map((function(){return e}))):n.from([e])})))}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Ze(){return new r.NgProbeToken("Router",je)}var Ye=function(){function t(t,e){}var n;return n=t,t.forRoot=function(t,o){return{ngModule:n,providers:[Ve,Xe(t),{provide:Qe,useFactory:Je,deps:[[je,new r.Optional,new r.SkipSelf]]},{provide:We,useValue:o||{}},{provide:e.LocationStrategy,useFactory:Ke,deps:[e.PlatformLocation,[new r.Inject(e.APP_BASE_HREF),new r.Optional],We]},{provide:Be,useFactory:$e,deps:[je,e.ViewportScroller,We]},{provide:De,useExisting:o&&o.preloadingStrategy?o.preloadingStrategy:He},{provide:r.NgProbeToken,multi:!0,useFactory:Ze},ar()]}},t.forChild=function(t){return{ngModule:n,providers:[Xe(t)]}},n=s([r.NgModule({declarations:Ge,exports:Ge,entryComponents:[E]}),c(0,r.Optional()),c(0,r.Inject(Qe)),c(1,r.Optional()),l("design:paramtypes",[Object,je])],t)}();function $e(t,e,r){return r.scrollOffset&&e.setOffset(r.scrollOffset),new Be(t,e,r)}function Ke(t,r,n){return void 0===n&&(n={}),n.useHash?new e.HashLocationStrategy(t,r):new e.PathLocationStrategy(t,r)}function Je(t){if(t)throw new Error("RouterModule.forRoot() called twice. Lazy loaded modules should use RouterModule.forChild() instead.");return"guarded"}function Xe(t){return[{provide:r.ANALYZE_FOR_ENTRY_COMPONENTS,multi:!0,useValue:t},{provide:Re,multi:!0,useValue:t}]}function tr(t,r,n,o,i,a,u,s,c,l){void 0===s&&(s={});var p=new je(null,t,r,n,o,i,a,B(u));if(c&&(p.urlHandlingStrategy=c),l&&(p.routeReuseStrategy=l),s.errorHandler&&(p.errorHandler=s.errorHandler),s.malformedUriErrorHandler&&(p.malformedUriErrorHandler=s.malformedUriErrorHandler),s.enableTracing){var h=e.ɵgetDOM();p.events.subscribe((function(t){h.logGroup("Router Event: "+t.constructor.name),h.log(t.toString()),h.log(t),h.logGroupEnd()}))}return s.onSameUrlNavigation&&(p.onSameUrlNavigation=s.onSameUrlNavigation),s.paramsInheritanceStrategy&&(p.paramsInheritanceStrategy=s.paramsInheritanceStrategy),s.urlUpdateStrategy&&(p.urlUpdateStrategy=s.urlUpdateStrategy),s.relativeLinkResolution&&(p.relativeLinkResolution=s.relativeLinkResolution),p}function er(t){return t.routerState.root}var rr=function(){function t(t){this.injector=t,this.initNavigation=!1,this.resultOfPreactivationDone=new n.Subject}return t.prototype.appInitializer=function(){var t=this;return this.injector.get(e.LOCATION_INITIALIZED,Promise.resolve(null)).then((function(){var e=null,r=new Promise((function(t){return e=t})),o=t.injector.get(je),i=t.injector.get(We);if(t.isLegacyDisabled(i)||t.isLegacyEnabled(i))e(!0);else if("disabled"===i.initialNavigation)o.setUpLocationChangeListener(),e(!0);else{if("enabled"!==i.initialNavigation)throw new Error("Invalid initialNavigation options: '"+i.initialNavigation+"'");o.hooks.afterPreactivation=function(){return t.initNavigation?n.of(null):(t.initNavigation=!0,e(!0),t.resultOfPreactivationDone)},o.initialNavigation()}return r}))},t.prototype.bootstrapListener=function(t){var e=this.injector.get(We),n=this.injector.get(Fe),o=this.injector.get(Be),i=this.injector.get(je),a=this.injector.get(r.ApplicationRef);t===a.components[0]&&(this.isLegacyEnabled(e)?i.initialNavigation():this.isLegacyDisabled(e)&&i.setUpLocationChangeListener(),n.setUpPreloading(),o.init(),i.resetRootComponentType(a.componentTypes[0]),this.resultOfPreactivationDone.next(null),this.resultOfPreactivationDone.complete())},t.prototype.isLegacyEnabled=function(t){return"legacy_enabled"===t.initialNavigation||!0===t.initialNavigation||void 0===t.initialNavigation},t.prototype.isLegacyDisabled=function(t){return"legacy_disabled"===t.initialNavigation||!1===t.initialNavigation},s([r.Injectable(),l("design:paramtypes",[r.Injector])],t)}();function nr(t){return t.appInitializer.bind(t)}function or(t){return t.bootstrapListener.bind(t)}var ir=new r.InjectionToken("Router Initializer");function ar(){return[rr,{provide:r.APP_INITIALIZER,multi:!0,useFactory:nr,deps:[rr]},{provide:ir,useFactory:or,deps:[rr]},{provide:r.APP_BOOTSTRAP_LISTENER,multi:!0,useExisting:ir}]}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var ur=new r.Version("10.0.0-next.7+63.sha-3d7c85b2");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */t.ActivatedRoute=bt,t.ActivatedRouteSnapshot=Rt,t.ActivationEnd=A,t.ActivationStart=x,t.ChildActivationEnd=_,t.ChildActivationStart=O,t.ChildrenOutletContexts=Oe,t.DefaultUrlSerializer=tt,t.GuardsCheckEnd=b,t.GuardsCheckStart=w,t.NavigationCancel=m,t.NavigationEnd=v,t.NavigationError=y,t.NavigationStart=g,t.NoPreloading=He,t.OutletContext=Pe,t.PRIMARY_OUTLET="primary",t.PreloadAllModules=ze,t.PreloadingStrategy=De,t.ROUTER_CONFIGURATION=We,t.ROUTER_INITIALIZER=ir,t.ROUTES=Re,t.ResolveEnd=R,t.ResolveStart=C,t.RouteConfigLoadEnd=P,t.RouteConfigLoadStart=U,t.RouteReuseStrategy=be,t.Router=je,t.RouterEvent=d,t.RouterLink=ke,t.RouterLinkActive=Me,t.RouterLinkWithHref=Ie,t.RouterModule=Ye,t.RouterOutlet=Ne,t.RouterPreloader=Fe,t.RouterState=St,t.RouterStateSnapshot=Ut,t.RoutesRecognized=S,t.Scroll=T,t.UrlHandlingStrategy=_e,t.UrlSegment=$,t.UrlSegmentGroup=Y,t.UrlSerializer=X,t.UrlTree=Z,t.VERSION=ur,t.convertToParamMap=k,t.provideRoutes=Xe,t.ɵEmptyOutletComponent=E,t.ɵROUTER_PROVIDERS=Ve,t.ɵangular_packages_router_router_a=Qe,t.ɵangular_packages_router_router_b=Ze,t.ɵangular_packages_router_router_c=$e,t.ɵangular_packages_router_router_d=Ke,t.ɵangular_packages_router_router_e=Je,t.ɵangular_packages_router_router_f=tr,t.ɵangular_packages_router_router_g=er,t.ɵangular_packages_router_router_h=rr,t.ɵangular_packages_router_router_i=nr,t.ɵangular_packages_router_router_j=or,t.ɵangular_packages_router_router_k=ar,t.ɵangular_packages_router_router_l=E,t.ɵangular_packages_router_router_m=dt,t.ɵangular_packages_router_router_n=mt,t.ɵangular_packages_router_router_o=Be,t.ɵflatten=B,Object.defineProperty(t,"__esModule",{value:!0})}));