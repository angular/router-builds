...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var me=function me(){},ye=function(){function t(){}return t.prototype.shouldDetach=function(t){return!1},t.prototype.store=function(t,e){},t.prototype.shouldAttach=function(t){return!1},t.prototype.retrieve=function(t){return null},t.prototype.shouldReuseRoute=function(t,e){return t.routeConfig===e.routeConfig},t}(),Se=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return a(e,t),e}(ye),be=new r.InjectionToken("ROUTES"),Ce=function(){function t(t,e,r,n){this.loader=t,this.compiler=e,this.onLoadStartListener=r,this.onLoadEndListener=n}return t.prototype.load=function(t,e){var r=this;return this.onLoadStartListener&&this.onLoadStartListener(e),this.loadModuleFactory(e.loadChildren).pipe(i.map((function(n){r.onLoadEndListener&&r.onLoadEndListener(e);var i=n.create(t);return new Et(k(i.injector.get(be)).map(Ht),i)})))},t.prototype.loadModuleFactory=function(t){var e=this;return"string"==typeof t?n.from(this.loader.load(t)):M(t()).pipe(i.mergeMap((function(t){return t instanceof r.NgModuleFactory?n.of(t):n.from(e.compiler.compileModuleAsync(t))})))},t}(),we=function we(){this.outlet=null,this.route=null,this.resolver=null,this.children=new Re,this.attachRef=null},Re=function(){function t(){this.contexts=new Map}return t.prototype.onChildOutletCreated=function(t,e){var r=this.getOrCreateContext(t);r.outlet=e,this.contexts.set(t,r)},t.prototype.onChildOutletDestroyed=function(t){var e=this.getContext(t);e&&(e.outlet=null)},t.prototype.onOutletDeactivated=function(){var t=this.contexts;return this.contexts=new Map,t},t.prototype.onOutletReAttached=function(t){this.contexts=t},t.prototype.getOrCreateContext=function(t){var e=this.getContext(t);return e||(e=new we,this.contexts.set(t,e)),e},t.prototype.getContext=function(t){return this.contexts.get(t)||null},t}(),Oe=function Oe(){},Ue=function(){function t(){}return t.prototype.shouldProcessUrl=function(t){return!0},t.prototype.extract=function(t){return t},t.prototype.merge=function(t,e){return t},t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var He=[Ie,Ae,Te,ke,Lt],Fe=new r.InjectionToken("ROUTER_CONFIGURATION"),Ge=new r.InjectionToken("ROUTER_FORROOT_GUARD"),We=[e.Location,{provide:G,useClass:W},{provide:xe,useFactory:Ke,deps:[G,Re,e.Location,r.Injector,r.NgModuleFactoryLoader,r.Compiler,be,Fe,[Oe,new r.Optional],[me,new r.Optional]]},Re,{provide:pt,useFactory:Xe,deps:[xe]},{provide:r.NgModuleFactoryLoader,useClass:r.SystemJsNgModuleLoader},De,qe,Ne,{provide:Fe,useValue:{enableTracing:!1}}];function Be(){return new r.NgProbeToken("Router",xe)}var Qe=function(){function t(t,e){}return t.forRoot=function(n,i){return{ngModule:t,providers:[We,$e(n),{provide:Ge,useFactory:Ze,deps:[[xe,new r.Optional,new r.SkipSelf]]},{provide:Fe,useValue:i||{}},{provide:e.LocationStrategy,useFactory:Ye,deps:[e.PlatformLocation,[new r.Inject(e.APP_BASE_HREF),new r.Optional],Fe]},{provide:ze,useFactory:Ve,deps:[xe,e.ViewportScroller,Fe]},{provide:Me,useExisting:i&&i.preloadingStrategy?i.preloadingStrategy:qe},{provide:r.NgProbeToken,multi:!0,useFactory:Be},ir()]}},t.forChild=function(e){return{ngModule:t,providers:[$e(e)]}},t}();function Ve(t,e,r){return r.scrollOffset&&e.setOffset(r.scrollOffset),new ze(t,e,r)}function Ye(t,r,n){return void 0===n&&(n={}),n.useHash?new e.HashLocationStrategy(t,r):new e.PathLocationStrategy(t,r)}function Ze(t){return"guarded"}function $e(t){return[{provide:r.ANALYZE_FOR_ENTRY_COMPONENTS,multi:!0,useValue:t},{provide:be,multi:!0,useValue:t}]}function Ke(t,r,n,i,o,a,u,s,c,l){void 0===s&&(s={});var p=new xe(null,t,r,n,i,o,a,k(u));if(c&&(p.urlHandlingStrategy=c),l&&(p.routeReuseStrategy=l),Je(s,p),s.enableTracing){var h=e.ɵgetDOM();p.events.subscribe((function(t){h.logGroup("Router Event: "+t.constructor.name),h.log(t.toString()),h.log(t),h.logGroupEnd()}))}return p}function Je(t,e){t.errorHandler&&(e.errorHandler=t.errorHandler),t.malformedUriErrorHandler&&(e.malformedUriErrorHandler=t.malformedUriErrorHandler),t.onSameUrlNavigation&&(e.onSameUrlNavigation=t.onSameUrlNavigation),t.paramsInheritanceStrategy&&(e.paramsInheritanceStrategy=t.paramsInheritanceStrategy),t.relativeLinkResolution&&(e.relativeLinkResolution=t.relativeLinkResolution),t.urlUpdateStrategy&&(e.urlUpdateStrategy=t.urlUpdateStrategy)}function Xe(t){return t.routerState.root}Qe.decorators=[{type:r.NgModule,args:[{declarations:He,exports:He,entryComponents:[Lt]}]}],Qe.ctorParameters=function(){return[{type:void 0,decorators:[{type:r.Optional},{type:r.Inject,args:[Ge]}]},{type:xe,decorators:[{type:r.Optional}]}]};var tr=function(){function t(t){this.injector=t,this.initNavigation=!1,this.resultOfPreactivationDone=new n.Subject}return t.prototype.appInitializer=function(){var t=this;return this.injector.get(e.LOCATION_INITIALIZED,Promise.resolve(null)).then((function(){var e=null,r=new Promise((function(t){return e=t})),i=t.injector.get(xe),o=t.injector.get(Fe);if(t.isLegacyDisabled(o)||t.isLegacyEnabled(o))e(!0);else if("disabled"===o.initialNavigation)i.setUpLocationChangeListener(),e(!0);else{if("enabled"!==o.initialNavigation)throw new Error("Invalid initialNavigation options: '"+o.initialNavigation+"'");i.hooks.afterPreactivation=function(){return t.initNavigation?n.of(null):(t.initNavigation=!0,e(!0),t.resultOfPreactivationDone)},i.initialNavigation()}return r}))},t.prototype.bootstrapListener=function(t){var e=this.injector.get(Fe),n=this.injector.get(De),i=this.injector.get(ze),o=this.injector.get(xe),a=this.injector.get(r.ApplicationRef);t===a.components[0]&&(this.isLegacyEnabled(e)?o.initialNavigation():this.isLegacyDisabled(e)&&o.setUpLocationChangeListener(),n.setUpPreloading(),i.init(),o.resetRootComponentType(a.componentTypes[0]),this.resultOfPreactivationDone.next(null),this.resultOfPreactivationDone.complete())},t.prototype.isLegacyEnabled=function(t){return"legacy_enabled"===t.initialNavigation||!0===t.initialNavigation||void 0===t.initialNavigation},t.prototype.isLegacyDisabled=function(t){return"legacy_disabled"===t.initialNavigation||!1===t.initialNavigation},t}();function er(t){return t.appInitializer.bind(t)}function rr(t){return t.bootstrapListener.bind(t)}tr.decorators=[{type:r.Injectable}],tr.ctorParameters=function(){return[{type:r.Injector}]};var nr=new r.InjectionToken("Router Initializer");function ir(){return[tr,{provide:r.APP_INITIALIZER,multi:!0,useFactory:er,deps:[tr]},{provide:nr,useFactory:rr,deps:[tr]},{provide:r.APP_BOOTSTRAP_LISTENER,multi:!0,useExisting:nr}]}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var or=new r.Version("11.0.0-next.5+18.sha-bf717b1");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */t.ActivatedRoute=pt,t.ActivatedRouteSnapshot=ft,t.ActivationEnd=U,t.ActivationStart=O,t.BaseRouteReuseStrategy=ye,t.ChildActivationEnd=R,t.ChildActivationStart=w,t.ChildrenOutletContexts=Re,t.DefaultUrlSerializer=W,t.GuardsCheckEnd=m,t.GuardsCheckStart=v,t.NavigationCancel=f,t.NavigationEnd=h,t.NavigationError=g,t.NavigationStart=p,t.NoPreloading=qe,t.OutletContext=we,t.PRIMARY_OUTLET="primary",t.PreloadAllModules=Ne,t.PreloadingStrategy=Me,t.ROUTER_CONFIGURATION=Fe,t.ROUTER_INITIALIZER=nr,t.ROUTES=be,t.ResolveEnd=S,t.ResolveStart=y,t.RouteConfigLoadEnd=C,t.RouteConfigLoadStart=b,t.RouteReuseStrategy=me,t.Router=xe,t.RouterEvent=l,t.RouterLink=Ae,t.RouterLinkActive=ke,t.RouterLinkWithHref=Te,t.RouterModule=Qe,t.RouterOutlet=Ie,t.RouterPreloader=De,t.RouterState=ct,t.RouterStateSnapshot=gt,t.RoutesRecognized=d,t.Scroll=P,t.UrlHandlingStrategy=Oe,t.UrlSegment=z,t.UrlSegmentGroup=D,t.UrlSerializer=G,t.UrlTree=q,t.VERSION=or,t.convertToParamMap=j,t.provideRoutes=$e,t.ɵEmptyOutletComponent=Lt,t.ɵROUTER_PROVIDERS=We,t.ɵangular_packages_router_router_a=Ge,t.ɵangular_packages_router_router_b=Be,t.ɵangular_packages_router_router_c=Ve,t.ɵangular_packages_router_router_d=Ye,t.ɵangular_packages_router_router_e=Ze,t.ɵangular_packages_router_router_f=Ke,t.ɵangular_packages_router_router_g=Xe,t.ɵangular_packages_router_router_h=tr,t.ɵangular_packages_router_router_i=er,t.ɵangular_packages_router_router_j=rr,t.ɵangular_packages_router_router_k=ir,t.ɵangular_packages_router_router_l=Lt,t.ɵangular_packages_router_router_m=it,t.ɵangular_packages_router_router_n=ut,t.ɵangular_packages_router_router_o=ze,t.ɵassignExtraOptionsToRouter=Je,t.ɵflatten=k,Object.defineProperty(t,"__esModule",{value:!0})}));