...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function ke(){return new e.NgProbeToken("Router",de)}var Le=function(){function t(t,e){}return t.forRoot=function(r,n){return{ngModule:t,providers:[je,qe(r),{provide:Ie,useFactory:Ne,deps:[[de,new e.Optional,new e.SkipSelf]]},{provide:Te,useValue:n||{}},{provide:o.LocationStrategy,useFactory:De,deps:[o.PlatformLocation,[new e.Inject(o.APP_BASE_HREF),new e.Optional],Te]},{provide:xe,useFactory:Me,deps:[de,o.ViewportScroller,Te]},{provide:_e,useExisting:n&&n.preloadingStrategy?n.preloadingStrategy:Oe},{provide:e.NgProbeToken,multi:!0,useFactory:ke},Qe()]}},t.forChild=function(e){return{ngModule:t,providers:[qe(e)]}},t.decorators=[{type:e.NgModule,args:[{declarations:Ue,exports:Ue,entryComponents:[x]}]}],t.ctorParameters=function(){return[{type:void 0,decorators:[{type:e.Optional},{type:e.Inject,args:[Ie]}]},{type:de,decorators:[{type:e.Optional}]}]},t}();function Me(t,e,r){return r.scrollOffset&&e.setOffset(r.scrollOffset),new xe(t,e,r)}function De(t,e,r){return void 0===r&&(r={}),r.useHash?new o.HashLocationStrategy(t,e):new o.PathLocationStrategy(t,e)}function Ne(t){if(t)throw new Error("RouterModule.forRoot() called twice. Lazy loaded modules should use RouterModule.forChild() instead.");return"guarded"}function qe(t){return[{provide:e.ANALYZE_FOR_ENTRY_COMPONENTS,multi:!0,useValue:t},{provide:se,multi:!0,useValue:t}]}function ze(t,e,r,n,o,a,u,s,c,l,h){void 0===c&&(c={});var p=new de(null,e,r,n,o,a,u,z(s));if(l&&(p.urlHandlingStrategy=l),h&&(p.routeReuseStrategy=h),c.errorHandler&&(p.errorHandler=c.errorHandler),c.enableTracing){var f=i.ɵgetDOM();p.events.subscribe(function(t){f.logGroup("Router Event: "+t.constructor.name),f.log(t.toString()),f.log(t),f.logGroupEnd()})}return c.onSameUrlNavigation&&(p.onSameUrlNavigation=c.onSameUrlNavigation),c.paramsInheritanceStrategy&&(p.paramsInheritanceStrategy=c.paramsInheritanceStrategy),p}function Ge(t){return t.routerState.root}var He=function(){function t(t){this.injector=t,this.initNavigation=!1,this.resultOfPreactivationDone=new r.Subject}return t.prototype.appInitializer=function(){var t=this;return this.injector.get(o.LOCATION_INITIALIZED,Promise.resolve(null)).then(function(){var e=null,n=new Promise(function(t){return e=t}),o=t.injector.get(de),i=t.injector.get(Te);if(t.isLegacyDisabled(i)||t.isLegacyEnabled(i))e(!0);else if("disabled"===i.initialNavigation)o.setUpLocationChangeListener(),e(!0);else{if("enabled"!==i.initialNavigation)throw new Error("Invalid initialNavigation options: '"+i.initialNavigation+"'");o.hooks.afterPreactivation=function(){return t.initNavigation?r.of(null):(t.initNavigation=!0,e(!0),t.resultOfPreactivationDone)},o.initialNavigation()}return n})},t.prototype.bootstrapListener=function(t){var r=this.injector.get(Te),n=this.injector.get(Ee),o=this.injector.get(xe),i=this.injector.get(de),a=this.injector.get(e.ApplicationRef);t===a.components[0]&&(this.isLegacyEnabled(r)?i.initialNavigation():this.isLegacyDisabled(r)&&i.setUpLocationChangeListener(),n.setUpPreloading(),o.init(),i.resetRootComponentType(a.componentTypes[0]),this.resultOfPreactivationDone.next(null),this.resultOfPreactivationDone.complete())},t.prototype.isLegacyEnabled=function(t){return"legacy_enabled"===t.initialNavigation||!0===t.initialNavigation||void 0===t.initialNavigation},t.prototype.isLegacyDisabled=function(t){return"legacy_disabled"===t.initialNavigation||!1===t.initialNavigation},t.decorators=[{type:e.Injectable}],t.ctorParameters=function(){return[{type:e.Injector}]},t}();function Fe(t){return t.appInitializer.bind(t)}function We(t){return t.bootstrapListener.bind(t)}var Be=new e.InjectionToken("Router Initializer");function Qe(){return[He,{provide:e.APP_INITIALIZER,multi:!0,useFactory:Fe,deps:[He]},{provide:Be,useFactory:We,deps:[He]},{provide:e.APP_BOOTSTRAP_LISTENER,multi:!0,useExisting:Be}]}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var Ve=new e.Version("6.1.0-beta.1+37.sha-ee2af9b");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
