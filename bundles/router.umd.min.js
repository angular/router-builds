...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function N(t,e){var r,n=Object.keys(t),o=Object.keys(e);if(n.length!=o.length)return!1;for(var i=0;i<n.length;i++)if(t[r=n[i]]!==e[r])return!1;return!0}function q(t){return Array.prototype.concat.apply([],t)}function z(t){return t.length>0?t[t.length-1]:null}function G(t,e){for(var r in t)t.hasOwnProperty(r)&&e(t[r],r)}function H(t){return t.pipe(n.mergeAll(),n.every(function(t){return!0===t}))}function F(t){return e.ɵisObservable(t)?t:e.ɵisPromise(t)?r.from(Promise.resolve(t)):r.of(t)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var ie=function ie(){},ae=function(){function t(){}return t.prototype.shouldDetach=function(t){return!1},t.prototype.store=function(t,e){},t.prototype.shouldAttach=function(t){return!1},t.prototype.retrieve=function(t){return null},t.prototype.shouldReuseRoute=function(t,e){return t.routeConfig===e.routeConfig},t}(),ue=new e.InjectionToken("ROUTES"),se=function(){function t(t,e,r,n){this.loader=t,this.compiler=e,this.onLoadStartListener=r,this.onLoadEndListener=n}return t.prototype.load=function(t,e){var r=this;return this.onLoadStartListener&&this.onLoadStartListener(e),this.loadModuleFactory(e.loadChildren).pipe(n.map(function(n){r.onLoadEndListener&&r.onLoadEndListener(e);var o=n.create(t);return new j(q(o.injector.get(ue)).map(D),o)}))},t.prototype.loadModuleFactory=function(t){var o=this;return"string"==typeof t?r.from(this.loader.load(t)):F(t()).pipe(n.mergeMap(function(t){return t instanceof e.NgModuleFactory?r.of(t):r.from(o.compiler.compileModuleAsync(t))}))},t}(),ce=function ce(){},le=function(){function t(){}return t.prototype.shouldProcessUrl=function(t){return!0},t.prototype.extract=function(t){return t},t.prototype.merge=function(t,e){return t},t}();
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function je(){return new e.NgProbeToken("Router",fe)}var ke=function(){function t(t,e){}return t.forRoot=function(r,n){return{ngModule:t,providers:[Ie,Ne(r),{provide:Te,useFactory:De,deps:[[fe,new e.Optional,new e.SkipSelf]]},{provide:Ue,useValue:n||{}},{provide:o.LocationStrategy,useFactory:Me,deps:[o.PlatformLocation,[new e.Inject(o.APP_BASE_HREF),new e.Optional],Ue]},{provide:Ee,useFactory:Le,deps:[fe,o.ViewportScroller,Ue]},{provide:Pe,useExisting:n&&n.preloadingStrategy?n.preloadingStrategy:Ae},{provide:e.NgProbeToken,multi:!0,useFactory:je},Be()]}},t.forChild=function(e){return{ngModule:t,providers:[Ne(e)]}},t.decorators=[{type:e.NgModule,args:[{declarations:xe,exports:xe}]}],t.ctorParameters=function(){return[{type:void 0,decorators:[{type:e.Optional},{type:e.Inject,args:[Te]}]},{type:fe,decorators:[{type:e.Optional}]}]},t}();function Le(t,e,r){return r.scrollOffset&&e.setOffset(r.scrollOffset),new Ee(t,e,r)}function Me(t,e,r){return void 0===r&&(r={}),r.useHash?new o.HashLocationStrategy(t,e):new o.PathLocationStrategy(t,e)}function De(t){if(t)throw new Error("RouterModule.forRoot() called twice. Lazy loaded modules should use RouterModule.forChild() instead.");return"guarded"}function Ne(t){return[{provide:e.ANALYZE_FOR_ENTRY_COMPONENTS,multi:!0,useValue:t},{provide:ue,multi:!0,useValue:t}]}function qe(t,e,r,n,o,a,u,s,c,l,h){void 0===c&&(c={});var p=new fe(null,e,r,n,o,a,u,q(s));if(l&&(p.urlHandlingStrategy=l),h&&(p.routeReuseStrategy=h),c.errorHandler&&(p.errorHandler=c.errorHandler),c.enableTracing){var f=i.ɵgetDOM();p.events.subscribe(function(t){f.logGroup("Router Event: "+t.constructor.name),f.log(t.toString()),f.log(t),f.logGroupEnd()})}return c.onSameUrlNavigation&&(p.onSameUrlNavigation=c.onSameUrlNavigation),c.paramsInheritanceStrategy&&(p.paramsInheritanceStrategy=c.paramsInheritanceStrategy),p}function ze(t){return t.routerState.root}var Ge=function(){function t(t){this.injector=t,this.initNavigation=!1,this.resultOfPreactivationDone=new r.Subject}return t.prototype.appInitializer=function(){var t=this;return this.injector.get(o.LOCATION_INITIALIZED,Promise.resolve(null)).then(function(){var e=null,n=new Promise(function(t){return e=t}),o=t.injector.get(fe),i=t.injector.get(Ue);if(t.isLegacyDisabled(i)||t.isLegacyEnabled(i))e(!0);else if("disabled"===i.initialNavigation)o.setUpLocationChangeListener(),e(!0);else{if("enabled"!==i.initialNavigation)throw new Error("Invalid initialNavigation options: '"+i.initialNavigation+"'");o.hooks.afterPreactivation=function(){return t.initNavigation?r.of(null):(t.initNavigation=!0,e(!0),t.resultOfPreactivationDone)},o.initialNavigation()}return n})},t.prototype.bootstrapListener=function(t){var r=this.injector.get(Ue),n=this.injector.get(Oe),o=this.injector.get(Ee),i=this.injector.get(fe),a=this.injector.get(e.ApplicationRef);t===a.components[0]&&(this.isLegacyEnabled(r)?i.initialNavigation():this.isLegacyDisabled(r)&&i.setUpLocationChangeListener(),n.setUpPreloading(),o.init(),i.resetRootComponentType(a.componentTypes[0]),this.resultOfPreactivationDone.next(null),this.resultOfPreactivationDone.complete())},t.prototype.isLegacyEnabled=function(t){return"legacy_enabled"===t.initialNavigation||!0===t.initialNavigation||void 0===t.initialNavigation},t.prototype.isLegacyDisabled=function(t){return"legacy_disabled"===t.initialNavigation||!1===t.initialNavigation},t.decorators=[{type:e.Injectable}],t.ctorParameters=function(){return[{type:e.Injector}]},t}();function He(t){return t.appInitializer.bind(t)}function Fe(t){return t.bootstrapListener.bind(t)}var We=new e.InjectionToken("Router Initializer");function Be(){return[Ge,{provide:e.APP_INITIALIZER,multi:!0,useFactory:He,deps:[Ge]},{provide:We,useFactory:Fe,deps:[Ge]},{provide:e.APP_BOOTSTRAP_LISTENER,multi:!0,useExisting:We}]}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var Qe=new e.Version("6.1.0-beta.0+43.sha-6ea6926");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */t.ɵangular_packages_router_router_a=Te,t.ɵangular_packages_router_router_h=Ge,t.ɵangular_packages_router_router_c=Le,t.ɵangular_packages_router_router_i=He,t.ɵangular_packages_router_router_j=Fe,t.ɵangular_packages_router_router_e=De,t.ɵangular_packages_router_router_d=Me,t.ɵangular_packages_router_router_k=Be,t.ɵangular_packages_router_router_g=ze,t.ɵangular_packages_router_router_b=je,t.ɵangular_packages_router_router_f=qe,t.ɵangular_packages_router_router_n=Ee,t.ɵangular_packages_router_router_l=Ct,t.ɵangular_packages_router_router_m=Pt,t.RouterLink=ve,t.RouterLinkWithHref=me,t.RouterLinkActive=Se,t.RouterOutlet=be,t.ActivationEnd=O,t.ActivationStart=A,t.ChildActivationEnd=_,t.ChildActivationStart=P,t.GuardsCheckEnd=S,t.GuardsCheckStart=y,t.NavigationCancel=g,t.NavigationEnd=d,t.NavigationError=v,t.NavigationStart=f,t.ResolveEnd=C,t.ResolveStart=w,t.RouteConfigLoadEnd=R,t.RouteConfigLoadStart=b,t.RouterEvent=p,t.RoutesRecognized=m,t.Scroll=E,t.RouteReuseStrategy=ie,t.Router=fe,t.ROUTES=ue,t.ROUTER_CONFIGURATION=Ue,t.ROUTER_INITIALIZER=We,t.RouterModule=ke,t.provideRoutes=Ne,t.ChildrenOutletContexts=Ce,t.OutletContext=we,t.NoPreloading=Ae,t.PreloadAllModules=_e,t.PreloadingStrategy=Pe,t.RouterPreloader=Oe,t.ActivatedRoute=Et,t.ActivatedRouteSnapshot=Ut,t.RouterState=At,t.RouterStateSnapshot=Tt,t.PRIMARY_OUTLET=x,t.convertToParamMap=T,t.UrlHandlingStrategy=ce,t.DefaultUrlSerializer=Y,t.UrlSegment=V,t.UrlSegmentGroup=Q,t.UrlSerializer=K,t.UrlTree=B,t.VERSION=Qe,t.ɵROUTER_PROVIDERS=Ie,t.ɵflatten=q,Object.defineProperty(t,"__esModule",{value:!0})});