...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var ze=[ke,_e,je,Te,It],De=new r.InjectionToken("ROUTER_CONFIGURATION"),He=new r.InjectionToken("ROUTER_FORROOT_GUARD"),Fe=[e.Location,{provide:F,useClass:G},{provide:xe,useFactory:Ye,deps:[F,Ce,e.Location,r.Injector,r.NgModuleFactoryLoader,r.Compiler,ye,De,[we,new r.Optional],[de,new r.Optional]]},Ce,{provide:lt,useFactory:Ke,deps:[xe]},{provide:r.NgModuleFactoryLoader,useClass:r.SystemJsNgModuleLoader},Ne,Me,Le,{provide:De,useValue:{enableTracing:!1}}];function Ge(){return new r.NgProbeToken("Router",xe)}var We=function(){function t(t,e){}return t.forRoot=function(n,i){return{ngModule:t,providers:[Fe,Qe(n),{provide:He,useFactory:Ze,deps:[[xe,new r.Optional,new r.SkipSelf]]},{provide:De,useValue:i||{}},{provide:e.LocationStrategy,useFactory:Ve,deps:[e.PlatformLocation,[new r.Inject(e.APP_BASE_HREF),new r.Optional],De]},{provide:qe,useFactory:Be,deps:[xe,e.ViewportScroller,De]},{provide:Ie,useExisting:i&&i.preloadingStrategy?i.preloadingStrategy:Me},{provide:r.NgProbeToken,multi:!0,useFactory:Ge},rr()]}},t.forChild=function(e){return{ngModule:t,providers:[Qe(e)]}},t}();function Be(t,e,r){return r.scrollOffset&&e.setOffset(r.scrollOffset),new qe(t,e,r)}function Ve(t,r,n){return void 0===n&&(n={}),n.useHash?new e.HashLocationStrategy(t,r):new e.PathLocationStrategy(t,r)}function Ze(t){return"guarded"}function Qe(t){return[{provide:r.ANALYZE_FOR_ENTRY_COMPONENTS,multi:!0,useValue:t},{provide:ye,multi:!0,useValue:t}]}function Ye(t,r,n,i,o,a,u,s,c,l){void 0===s&&(s={});var p=new xe(null,t,r,n,i,o,a,E(u));if(c&&(p.urlHandlingStrategy=c),l&&(p.routeReuseStrategy=l),$e(s,p),s.enableTracing){var h=e.ɵgetDOM();p.events.subscribe((function(t){h.logGroup("Router Event: "+t.constructor.name),h.log(t.toString()),h.log(t),h.logGroupEnd()}))}return p}function $e(t,e){t.errorHandler&&(e.errorHandler=t.errorHandler),t.malformedUriErrorHandler&&(e.malformedUriErrorHandler=t.malformedUriErrorHandler),t.onSameUrlNavigation&&(e.onSameUrlNavigation=t.onSameUrlNavigation),t.paramsInheritanceStrategy&&(e.paramsInheritanceStrategy=t.paramsInheritanceStrategy),t.relativeLinkResolution&&(e.relativeLinkResolution=t.relativeLinkResolution),t.urlUpdateStrategy&&(e.urlUpdateStrategy=t.urlUpdateStrategy)}function Ke(t){return t.routerState.root}We.decorators=[{type:r.NgModule,args:[{declarations:ze,exports:ze,entryComponents:[It]}]}],We.ctorParameters=function(){return[{type:void 0,decorators:[{type:r.Optional},{type:r.Inject,args:[He]}]},{type:xe,decorators:[{type:r.Optional}]}]};var Je=function(){function t(t){this.injector=t,this.initNavigation=!1,this.resultOfPreactivationDone=new n.Subject}return t.prototype.appInitializer=function(){var t=this;return this.injector.get(e.LOCATION_INITIALIZED,Promise.resolve(null)).then((function(){var e=null,r=new Promise((function(t){return e=t})),i=t.injector.get(xe),o=t.injector.get(De);return"disabled"===o.initialNavigation?(i.setUpLocationChangeListener(),e(!0)):"enabled"===o.initialNavigation||"enabledBlocking"===o.initialNavigation?(i.hooks.afterPreactivation=function(){return t.initNavigation?n.of(null):(t.initNavigation=!0,e(!0),t.resultOfPreactivationDone)},i.initialNavigation()):e(!0),r}))},t.prototype.bootstrapListener=function(t){var e=this.injector.get(De),n=this.injector.get(Ne),i=this.injector.get(qe),o=this.injector.get(xe),a=this.injector.get(r.ApplicationRef);t===a.components[0]&&("enabledNonBlocking"!==e.initialNavigation&&void 0!==e.initialNavigation||o.initialNavigation(),n.setUpPreloading(),i.init(),o.resetRootComponentType(a.componentTypes[0]),this.resultOfPreactivationDone.next(null),this.resultOfPreactivationDone.complete())},t}();function Xe(t){return t.appInitializer.bind(t)}function tr(t){return t.bootstrapListener.bind(t)}Je.decorators=[{type:r.Injectable}],Je.ctorParameters=function(){return[{type:r.Injector}]};var er=new r.InjectionToken("Router Initializer");function rr(){return[Je,{provide:r.APP_INITIALIZER,multi:!0,useFactory:Xe,deps:[Je]},{provide:er,useFactory:tr,deps:[Je]},{provide:r.APP_BOOTSTRAP_LISTENER,multi:!0,useExisting:er}]}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var nr=new r.Version("11.0.9+27.sha-d684e5a");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */t.ActivatedRoute=lt,t.ActivatedRouteSnapshot=ht,t.ActivationEnd=U,t.ActivationStart=O,t.BaseRouteReuseStrategy=ve,t.ChildActivationEnd=R,t.ChildActivationStart=w,t.ChildrenOutletContexts=Ce,t.DefaultUrlSerializer=G,t.GuardsCheckEnd=m,t.GuardsCheckStart=v,t.NavigationCancel=f,t.NavigationEnd=h,t.NavigationError=g,t.NavigationStart=p,t.NoPreloading=Me,t.OutletContext=be,t.PRIMARY_OUTLET="primary",t.PreloadAllModules=Le,t.PreloadingStrategy=Ie,t.ROUTER_CONFIGURATION=De,t.ROUTER_INITIALIZER=er,t.ROUTES=ye,t.ResolveEnd=S,t.ResolveStart=y,t.RouteConfigLoadEnd=C,t.RouteConfigLoadStart=b,t.RouteReuseStrategy=de,t.Router=xe,t.RouterEvent=l,t.RouterLink=_e,t.RouterLinkActive=Te,t.RouterLinkWithHref=je,t.RouterModule=We,t.RouterOutlet=ke,t.RouterPreloader=Ne,t.RouterState=st,t.RouterStateSnapshot=ft,t.RoutesRecognized=d,t.Scroll=P,t.UrlHandlingStrategy=we,t.UrlSegment=D,t.UrlSegmentGroup=z,t.UrlSerializer=F,t.UrlTree=q,t.VERSION=nr,t.convertToParamMap=_,t.provideRoutes=Qe,t.ɵEmptyOutletComponent=It,t.ɵROUTER_PROVIDERS=Fe,t.ɵangular_packages_router_router_a=He,t.ɵangular_packages_router_router_b=Ge,t.ɵangular_packages_router_router_c=Be,t.ɵangular_packages_router_router_d=Ve,t.ɵangular_packages_router_router_e=Ze,t.ɵangular_packages_router_router_f=Ye,t.ɵangular_packages_router_router_g=Ke,t.ɵangular_packages_router_router_h=Je,t.ɵangular_packages_router_router_i=Xe,t.ɵangular_packages_router_router_j=tr,t.ɵangular_packages_router_router_k=rr,t.ɵangular_packages_router_router_l=It,t.ɵangular_packages_router_router_m=nt,t.ɵangular_packages_router_router_n=at,t.ɵangular_packages_router_router_o=qe,t.ɵassignExtraOptionsToRouter=$e,t.ɵflatten=E,Object.defineProperty(t,"__esModule",{value:!0})}));