 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function je(){return new r.NgProbeToken("Router",fe)}var ke=function(){function t(t,e){}return t.forRoot=function(n,o){return{ngModule:t,providers:[Ie,Ne(n),{provide:Te,useFactory:De,deps:[[fe,new r.Optional,new r.SkipSelf]]},{provide:Ue,useValue:o||{}},{provide:e.LocationStrategy,useFactory:Me,deps:[e.PlatformLocation,[new r.Inject(e.APP_BASE_HREF),new r.Optional],Ue]},{provide:Ee,useFactory:Le,deps:[fe,e.ViewportScroller,Ue]},{provide:Pe,useExisting:o&&o.preloadingStrategy?o.preloadingStrategy:Ae},{provide:r.NgProbeToken,multi:!0,useFactory:je},Be()]}},t.forChild=function(e){return{ngModule:t,providers:[Ne(e)]}},t.decorators=[{type:r.NgModule,args:[{declarations:xe,exports:xe}]}],t.ctorParameters=function(){return[{type:void 0,decorators:[{type:r.Optional},{type:r.Inject,args:[Te]}]},{type:fe,decorators:[{type:r.Optional}]}]},t}();function Le(t,e,r){return r.scrollOffset&&e.setOffset(r.scrollOffset),new Ee(t,e,r)}function Me(t,r,n){return void 0===n&&(n={}),n.useHash?new e.HashLocationStrategy(t,r):new e.PathLocationStrategy(t,r)}function De(t){if(t)throw new Error("RouterModule.forRoot() called twice. Lazy loaded modules should use RouterModule.forChild() instead.");return"guarded"}function Ne(t){return[{provide:r.ANALYZE_FOR_ENTRY_COMPONENTS,multi:!0,useValue:t},{provide:ue,multi:!0,useValue:t}]}function qe(t,e,r,n,o,a,u,s,c,l,h){void 0===c&&(c={});var p=new fe(null,e,r,n,o,a,u,q(s));if(l&&(p.urlHandlingStrategy=l),h&&(p.routeReuseStrategy=h),c.errorHandler&&(p.errorHandler=c.errorHandler),c.enableTracing){var f=i.ɵgetDOM();p.events.subscribe(function(t){f.logGroup("Router Event: "+t.constructor.name),f.log(t.toString()),f.log(t),f.logGroupEnd()})}return c.onSameUrlNavigation&&(p.onSameUrlNavigation=c.onSameUrlNavigation),c.paramsInheritanceStrategy&&(p.paramsInheritanceStrategy=c.paramsInheritanceStrategy),p}function ze(t){return t.routerState.root}var Ge=function(){function t(t){this.injector=t,this.initNavigation=!1,this.resultOfPreactivationDone=new n.Subject}return t.prototype.appInitializer=function(){var t=this;return this.injector.get(e.LOCATION_INITIALIZED,Promise.resolve(null)).then(function(){var e=null,r=new Promise(function(t){return e=t}),o=t.injector.get(fe),i=t.injector.get(Ue);if(t.isLegacyDisabled(i)||t.isLegacyEnabled(i))e(!0);else if("disabled"===i.initialNavigation)o.setUpLocationChangeListener(),e(!0);else{if("enabled"!==i.initialNavigation)throw new Error("Invalid initialNavigation options: '"+i.initialNavigation+"'");o.hooks.afterPreactivation=function(){return t.initNavigation?n.of(null):(t.initNavigation=!0,e(!0),t.resultOfPreactivationDone)},o.initialNavigation()}return r})},t.prototype.bootstrapListener=function(t){var e=this.injector.get(Ue),n=this.injector.get(Oe),o=this.injector.get(Ee),i=this.injector.get(fe),a=this.injector.get(r.ApplicationRef);t===a.components[0]&&(this.isLegacyEnabled(e)?i.initialNavigation():this.isLegacyDisabled(e)&&i.setUpLocationChangeListener(),n.setUpPreloading(),o.init(),i.resetRootComponentType(a.componentTypes[0]),this.resultOfPreactivationDone.next(null),this.resultOfPreactivationDone.complete())},t.prototype.isLegacyEnabled=function(t){return"legacy_enabled"===t.initialNavigation||!0===t.initialNavigation||void 0===t.initialNavigation},t.prototype.isLegacyDisabled=function(t){return"legacy_disabled"===t.initialNavigation||!1===t.initialNavigation},t.decorators=[{type:r.Injectable}],t.ctorParameters=function(){return[{type:r.Injector}]},t}();function He(t){return t.appInitializer.bind(t)}function Fe(t){return t.bootstrapListener.bind(t)}var We=new r.InjectionToken("Router Initializer");function Be(){return[Ge,{provide:r.APP_INITIALIZER,multi:!0,useFactory:He,deps:[Ge]},{provide:We,useFactory:Fe,deps:[Ge]},{provide:r.APP_BOOTSTRAP_LISTENER,multi:!0,useExisting:We}]}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var Qe=new r.Version("6.1.0-beta.0+38.sha-3ed2d75");
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
