...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var Se=function Se(){},be=function(){function t(){}return t.prototype.shouldDetach=function(t){return!1},t.prototype.store=function(t,e){},t.prototype.shouldAttach=function(t){return!1},t.prototype.retrieve=function(t){return null},t.prototype.shouldReuseRoute=function(t,e){return t.routeConfig===e.routeConfig},t}(),Ce=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return a(e,t),e}(be),we=new r.InjectionToken("ROUTES"),Re=function(){function t(t,e,r,n){this.loader=t,this.compiler=e,this.onLoadStartListener=r,this.onLoadEndListener=n}return t.prototype.load=function(t,e){var r=this;return this.onLoadStartListener&&this.onLoadStartListener(e),this.loadModuleFactory(e.loadChildren).pipe(i.map((function(n){r.onLoadEndListener&&r.onLoadEndListener(e);var i=n.create(t);return new Tt(E(i.injector.get(we)).map(Dt),i)})))},t.prototype.loadModuleFactory=function(t){var e=this;return"string"==typeof t?n.from(this.loader.load(t)):M(t()).pipe(i.mergeMap((function(t){return t instanceof r.NgModuleFactory?n.of(t):n.from(e.compiler.compileModuleAsync(t))})))},t}(),Oe=function Oe(){this.outlet=null,this.route=null,this.resolver=null,this.children=new Ue,this.attachRef=null},Ue=function(){function t(){this.contexts=new Map}return t.prototype.onChildOutletCreated=function(t,e){var r=this.getOrCreateContext(t);r.outlet=e,this.contexts.set(t,r)},t.prototype.onChildOutletDestroyed=function(t){var e=this.getContext(t);e&&(e.outlet=null)},t.prototype.onOutletDeactivated=function(){var t=this.contexts;return this.contexts=new Map,t},t.prototype.onOutletReAttached=function(t){this.contexts=t},t.prototype.getOrCreateContext=function(t){var e=this.getContext(t);return e||(e=new Oe,this.contexts.set(t,e)),e},t.prototype.getContext=function(t){return this.contexts.get(t)||null},t}(),Pe=function Pe(){},xe=function(){function t(){}return t.prototype.shouldProcessUrl=function(t){return!0},t.prototype.extract=function(t){return t},t.prototype.merge=function(t,e){return t},t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Ge=[Me,ke,Ee,Le,It],We=new r.InjectionToken("ROUTER_CONFIGURATION"),Be=new r.InjectionToken("ROUTER_FORROOT_GUARD"),Ve=[e.Location,{provide:F,useClass:G},{provide:Te,useFactory:Xe,deps:[F,Ue,e.Location,r.Injector,r.NgModuleFactoryLoader,r.Compiler,we,We,[Pe,new r.Optional],[Se,new r.Optional]]},Ue,{provide:lt,useFactory:er,deps:[Te]},{provide:r.NgModuleFactoryLoader,useClass:r.SystemJsNgModuleLoader},He,De,ze,{provide:We,useValue:{enableTracing:!1}}];function Qe(){return new r.NgProbeToken("Router",Te)}var Ye=function(){function t(t,e){}return t.forRoot=function(n,i){return{ngModule:t,providers:[Ve,Je(n),{provide:Be,useFactory:Ke,deps:[[Te,new r.Optional,new r.SkipSelf]]},{provide:We,useValue:i||{}},{provide:e.LocationStrategy,useFactory:$e,deps:[e.PlatformLocation,[new r.Inject(e.APP_BASE_HREF),new r.Optional],We]},{provide:Fe,useFactory:Ze,deps:[Te,e.ViewportScroller,We]},{provide:qe,useExisting:i&&i.preloadingStrategy?i.preloadingStrategy:De},{provide:r.NgProbeToken,multi:!0,useFactory:Qe},ar()]}},t.forChild=function(e){return{ngModule:t,providers:[Je(e)]}},t}();function Ze(t,e,r){return r.scrollOffset&&e.setOffset(r.scrollOffset),new Fe(t,e,r)}function $e(t,r,n){return void 0===n&&(n={}),n.useHash?new e.HashLocationStrategy(t,r):new e.PathLocationStrategy(t,r)}function Ke(t){return"guarded"}function Je(t){return[{provide:r.ANALYZE_FOR_ENTRY_COMPONENTS,multi:!0,useValue:t},{provide:we,multi:!0,useValue:t}]}function Xe(t,r,n,i,o,a,u,s,c,l){void 0===s&&(s={});var p=new Te(null,t,r,n,i,o,a,E(u));if(c&&(p.urlHandlingStrategy=c),l&&(p.routeReuseStrategy=l),tr(s,p),s.enableTracing){var h=e.ɵgetDOM();p.events.subscribe((function(t){h.logGroup("Router Event: "+t.constructor.name),h.log(t.toString()),h.log(t),h.logGroupEnd()}))}return p}function tr(t,e){t.errorHandler&&(e.errorHandler=t.errorHandler),t.malformedUriErrorHandler&&(e.malformedUriErrorHandler=t.malformedUriErrorHandler),t.onSameUrlNavigation&&(e.onSameUrlNavigation=t.onSameUrlNavigation),t.paramsInheritanceStrategy&&(e.paramsInheritanceStrategy=t.paramsInheritanceStrategy),t.relativeLinkResolution&&(e.relativeLinkResolution=t.relativeLinkResolution),t.urlUpdateStrategy&&(e.urlUpdateStrategy=t.urlUpdateStrategy)}function er(t){return t.routerState.root}Ye.decorators=[{type:r.NgModule,args:[{declarations:Ge,exports:Ge,entryComponents:[It]}]}],Ye.ctorParameters=function(){return[{type:void 0,decorators:[{type:r.Optional},{type:r.Inject,args:[Be]}]},{type:Te,decorators:[{type:r.Optional}]}]};var rr=function(){function t(t){this.injector=t,this.initNavigation=!1,this.resultOfPreactivationDone=new n.Subject}return t.prototype.appInitializer=function(){var t=this;return this.injector.get(e.LOCATION_INITIALIZED,Promise.resolve(null)).then((function(){var e=null,r=new Promise((function(t){return e=t})),i=t.injector.get(Te),o=t.injector.get(We);return"disabled"===o.initialNavigation?(i.setUpLocationChangeListener(),e(!0)):"enabled"===o.initialNavigation||"enabledBlocking"===o.initialNavigation?(i.hooks.afterPreactivation=function(){return t.initNavigation?n.of(null):(t.initNavigation=!0,e(!0),t.resultOfPreactivationDone)},i.initialNavigation()):e(!0),r}))},t.prototype.bootstrapListener=function(t){var e=this.injector.get(We),n=this.injector.get(He),i=this.injector.get(Fe),o=this.injector.get(Te),a=this.injector.get(r.ApplicationRef);t===a.components[0]&&("enabledNonBlocking"!==e.initialNavigation&&void 0!==e.initialNavigation||o.initialNavigation(),n.setUpPreloading(),i.init(),o.resetRootComponentType(a.componentTypes[0]),this.resultOfPreactivationDone.next(null),this.resultOfPreactivationDone.complete())},t}();function nr(t){return t.appInitializer.bind(t)}function ir(t){return t.bootstrapListener.bind(t)}rr.decorators=[{type:r.Injectable}],rr.ctorParameters=function(){return[{type:r.Injector}]};var or=new r.InjectionToken("Router Initializer");function ar(){return[rr,{provide:r.APP_INITIALIZER,multi:!0,useFactory:nr,deps:[rr]},{provide:or,useFactory:ir,deps:[rr]},{provide:r.APP_BOOTSTRAP_LISTENER,multi:!0,useExisting:or}]}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var ur=new r.Version("11.1.0-next.3+57.sha-d5a7a26");
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */t.ActivatedRoute=lt,t.ActivatedRouteSnapshot=ht,t.ActivationEnd=U,t.ActivationStart=O,t.BaseRouteReuseStrategy=be,t.ChildActivationEnd=R,t.ChildActivationStart=w,t.ChildrenOutletContexts=Ue,t.DefaultUrlSerializer=G,t.GuardsCheckEnd=m,t.GuardsCheckStart=v,t.NavigationCancel=f,t.NavigationEnd=h,t.NavigationError=d,t.NavigationStart=p,t.NoPreloading=De,t.OutletContext=Oe,t.PRIMARY_OUTLET="primary",t.PreloadAllModules=ze,t.PreloadingStrategy=qe,t.ROUTER_CONFIGURATION=We,t.ROUTER_INITIALIZER=or,t.ROUTES=we,t.ResolveEnd=S,t.ResolveStart=y,t.RouteConfigLoadEnd=C,t.RouteConfigLoadStart=b,t.RouteReuseStrategy=Se,t.Router=Te,t.RouterEvent=l,t.RouterLink=ke,t.RouterLinkActive=Le,t.RouterLinkWithHref=Ee,t.RouterModule=Ye,t.RouterOutlet=Me,t.RouterPreloader=He,t.RouterState=st,t.RouterStateSnapshot=ft,t.RoutesRecognized=g,t.Scroll=P,t.UrlHandlingStrategy=Pe,t.UrlSegment=D,t.UrlSegmentGroup=z,t.UrlSerializer=F,t.UrlTree=q,t.VERSION=ur,t.convertToParamMap=_,t.provideRoutes=Je,t.ɵEmptyOutletComponent=It,t.ɵROUTER_PROVIDERS=Ve,t.ɵangular_packages_router_router_a=Be,t.ɵangular_packages_router_router_b=Qe,t.ɵangular_packages_router_router_c=Ze,t.ɵangular_packages_router_router_d=$e,t.ɵangular_packages_router_router_e=Ke,t.ɵangular_packages_router_router_f=Xe,t.ɵangular_packages_router_router_g=er,t.ɵangular_packages_router_router_h=rr,t.ɵangular_packages_router_router_i=nr,t.ɵangular_packages_router_router_j=ir,t.ɵangular_packages_router_router_k=ar,t.ɵangular_packages_router_router_l=It,t.ɵangular_packages_router_router_m=nt,t.ɵangular_packages_router_router_n=at,t.ɵangular_packages_router_router_o=Fe,t.ɵassignExtraOptionsToRouter=tr,t.ɵflatten=E,Object.defineProperty(t,"__esModule",{value:!0})}));