...
RouterTestingModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.0+27.sha-0115e2b.with-local-changes", ngImport: i0, type: RouterTestingModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
RouterTestingModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.0+27.sha-0115e2b.with-local-changes", ngImport: i0, type: RouterTestingModule, exports: [RouterModule] });
RouterTestingModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.1.0+27.sha-0115e2b.with-local-changes", ngImport: i0, type: RouterTestingModule, providers: [
        ROUTER_PROVIDERS,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.0+27.sha-0115e2b.with-local-changes", ngImport: i0, type: RouterTestingModule, decorators: [{
            type: NgModule,
            args: [{
