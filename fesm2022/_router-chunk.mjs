...
function squashSegmentGroup(segmentGroup) {
  ...
  const s = new UrlSegmentGroup(segmentGroup.segments.map(s => new UrlSegment(s.path, {
    ...s.parameters
  })), newChildren);
