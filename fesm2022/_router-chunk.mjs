...
function defaultUrlMatcher(segments, segmentGroup, route) {
  ...
  if (wildcardIndex === -1) {
    ...
    if (route.pathMatch === 'full' && (segmentGroup.hasChildren() || parts.length < segments.length) && (parts.length + 1 !== segments.length || segments[parts.length].path !== '')) {
      return null;
    }
    const posParams = {};
