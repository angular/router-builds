...
import { ViewportScroller, PlatformNavigation, PlatformLocation, ɵPRECOMMIT_HANDLER_SUPPORTED as _PRECOMMIT_HANDLER_SUPPORTED, Location, ɵNavigationAdapterForLocation as _NavigationAdapterForLocation, LOCATION_INITIALIZED, REMOVE_TRAILING_SLASH, LocationStrategy, HashLocationStrategy, PathLocationStrategy } from '@angular/common';
  ...
  static forRoot(routes, config) {
    return {
      ...
      providers: [ROUTER_PROVIDERS, typeof ngDevMode === 'undefined' || ngDevMode ? config?.enableTracing ? withDebugTracing().ɵproviders : [] : [], {
        ...
        provide: REMOVE_TRAILING_SLASH,
        useValue: config?.trailingSlash === 'always' || config?.trailingSlash === 'preserve' ? false : true
