...
class NavigationStateManager extends StateManager {
  ...
  handleNavigate(event) {
    ...
    if (!isTriggeredByRouterTransition && (!this.nonRouterEntryChangeListener || this.nonRouterEntryChangeListener.closed)) {
      return;
    }
