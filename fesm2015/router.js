...
let Router = /** @class */ (() => {
    ...
    Router = __decorate([
        ...
        __metadata("design:paramtypes", [Object, UrlSerializer,
            ChildrenOutletContexts, Location, Injector,
            NgModuleFactoryLoader, Compiler, Array])
    ], Router);
    return Router;
})();
