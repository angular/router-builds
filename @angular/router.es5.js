            ...
            if (typeof loadChildren === 'string') {
                ...
                return mergeMap.call(wrapIntoObservable(loadChildren()), function (t) {
                    if (t instanceof NgModuleFactory) {
                        ...
                        return fromPromise(_this2.compiler.compileModuleAsync(t));
                    }
                });
            }
        }
        ...
        value: function runNavigate(url, rawUrl, shouldPreventPushState, shouldReplaceUrl, id, precreatedState) {
            ...
            return new Promise(function (resolvePromise, rejectPromise) {
                ...
                var /** @type {?} */beforePreactivationDone$ = mergeMap.call(urlAndSnapshot$, function (p) {
                    return map.call(_this22.hooks.beforePreactivation(p.snapshot), function () {
                        return p;
                    });
                });
                // run preactivation: guards and data resolvers
                var /** @type {?} */preActivation = void 0;
                var /** @type {?} */preactivationTraverse$ = map.call(beforePreactivationDone$, function (_ref6) {
                ...
                var /** @type {?} */preactivationDone$ = mergeMap.call(preactivationResolveData$, function (p) {
                    return map.call(_this22.hooks.afterPreactivation(p.snapshot), function () {
                        return p;
                    });
                });
                // create router state
                // this operation has side effects => route state is being affected
                var /** @type {?} */routerState$ = map.call(preactivationDone$, function (_ref8) {
...
RouterInitializer.decorators = [{ type: Injectable }];
/** @nocollapse */
 ...
 * @stable
 */
var /** @type {?} */VERSION = new Version('4.0.0-rc.2-5ad5301');
