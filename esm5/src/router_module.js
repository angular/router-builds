...
var RouterModule = /** @class */ (function () {
    ...
    RouterModule.ngInjectorDef = i0.defineInjector({ factory: function RouterModule_Factory(t) { return new (t || RouterModule)(i0.inject(ROUTER_FORROOT_GUARD, 8), i0.inject(i1.Router, 8)); } });
    return RouterModule;
}());
export { RouterModule };
