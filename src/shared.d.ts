...
export declare function convertToParams(params: {
    [name: string]: any | any[];
}): Params;
export declare function equalsParams(a: Params, b: Params): boolean;
export declare function containsParams(a: Params, b: Params): boolean;
