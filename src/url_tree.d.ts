...
export declare function equalsTree(a: UrlTree, b: UrlTree): boolean;
export declare function containsTree(container: UrlTree, containee: UrlTree): boolean;
/**
...
export declare function serializePaths(group: UrlSegmentGroup): string;
/**
